...
static auto registry =
    torch::RegisterOperators()
        ...
        .op("spconv::indice_trans_invariant_conv", &spconv::indiceTransInvariantConv)
        .op("spconv::indice_trans_invariant_conv_backward", &spconv::indiceTransInvariantConvBackward)
        .op("spconv::indice_group", &spconv::indiceGroup)
        .op("spconv::indice_group_backward", &spconv::indiceGroupBackward)
